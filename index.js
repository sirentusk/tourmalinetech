...
function removeFromCart(index) {
    ...
    localStorage.setItem('cart', JSON.stringify(cart));
    updateCartUI();
    updateSummary(); // Update if on checkout
}

// Page-specific initialization
document.addEventListener('DOMContentLoaded', () => {
    // Main page logic (add-to-cart listeners, checkout redirect)
    ...
    // Checkout page logic (Stripe setup, form submission)
